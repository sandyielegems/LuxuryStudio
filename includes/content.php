            ...
            <div class="row">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="pricing-entry pb-5 text-center">
                        <div>
                            <h3 class="mb-4">Behandeling 1</h3>
                            <p><span class="price">35 euro</span>
                        ...
                        <p class="button text-center"><a href="#" class="btn btn-primary btn-outline-primary px-4 py-3">Afspraak aanvragen</a></p>
                    </div>
                </div>
                <div class="col-md-4 ftco-animate">
                    <div class="pricing-entry pb-5 text-center">
                        <div>
                            <h3 class="mb-4">Behandeling 2</h3>
                            <p><span class="price">70 euro</span>
                                <!-- <span class="per">/ one trip</span> -->
                            </p>
                        </div>
                        <ul>
                            <!-- <li>Manicure</li> -->
                            <li>Gelnagels plaatsen</li>
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="pricing-entry pb-5 text-center">
                        <div>
                            <h3 class="mb-4">Behandeling 3</h3>
                            <p><span class="price">40 euro</span>
                                <!-- <span class="per">/ one trip</span> -->
                            </p>
                        </div>
                        <ul>
                            <!-- <li>Manicure</li> -->
                            <li>Gelnagels bijwerken</li>
